...
<img src="docs/store/01-overview.png" alt="The CaseLens panel open over a USCIS account page, showing four cases as one-line rows with form, status and age." width="820">
